...
| removeFilesOnFailure         |          | true                                             | **true** / **false**                                         | If a plugin (like the OpenMHz or Broadcastify uploader) fails, should the files be saved locally or removed. If there is a prolonged outage for one of the services it could fill up storage. | 
