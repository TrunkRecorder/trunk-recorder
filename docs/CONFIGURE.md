...
| lcnTable                 |          |                            | object; `{ "1": 463112500, "2": 463612500, ... }`                                                                      | *Required for `"dmr"` systems.* Maps DMR Logical Channel Numbers (LCN) to RF frequencies (Hz). Voice channel grants reference LCN ids, not Hz; without this table grants cannot be tuned. |
